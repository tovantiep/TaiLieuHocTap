...
<html>
    <head>
        ...
        <link href="<?= base_url() ?>public/public/css/bootstrap/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url() ?>public/public/css/bootstrap/bootstrap-theme.min.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url() ?>public/public/reset.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url() ?>public/public/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url() ?>public/public/style.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url() ?>public/public/responsive.css" rel="stylesheet" type="text/css"/>

        <script src="<?= base_url() ?>public/public/js/jquery-2.2.4.min.js" type="text/javascript"></script>
        <script src="<?= base_url() ?>public/public/js/bootstrap/bootstrap.min.js" type="text/javascript"></script>
        <script src="<?= base_url() ?>public/public/js/main.js" type="text/javascript"></script>
    </head>
    <body>
        <div id="site">
            <div id="container">
                        ...
                        <div id="dropdown-user" class="dropdown dropdown-extended fl-right">
                            <button class="dropdown-toggle clearfix" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                <div id="thumb-circle" class="fl-left">
                                    <img src="<?= base_url() ?>public/public/images/img-admin.png">
                                </div>
