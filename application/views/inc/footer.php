<div id="footer-wp">
        ...
        <div class="wp-inner clearfix">
            <div class="block" id="about-us">
                ...
                <div class="detail">
                    <ul class="list-item">
                        <li>
                            <a href="mailto:vietsoz@gmail.com">vietsoz@gmail.com</a>
                        </li>
                        <li>
            ...
            <div class="block" id="fanpage">
                <div class="detail">
                    <div class="fb-page" data-href="https://www.facebook.com/1707310909585150/" data-width="300" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/1707310909585150/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/dambaumummim/">VietSOZ</a></blockquote></div>
                </div>
            </div>
        </div>
    </div>
    <div id="foot-bottom">
        <div class="wp-inner">
            <p id="copyright">© 2017 Vietsoz.com - All rights reserved.</p>
        </div>
    </div>
</div>
</div>
