        ...
        <div class="section" id="order-review-wp">
            ...
            <div class="section-detail">
                <table class="shop-table">
                    ...
                    <tbody>
                        <tr class="cart-item">
                            <td class="product-name">Đồ chơi chó mèo thông minh<strong class="product-quantity">x 1</strong></td>
                            <td class="product-total">350.000đ</td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Đồ chơi xe đẩy<strong class="product-quantity">x 2</strong></td>
